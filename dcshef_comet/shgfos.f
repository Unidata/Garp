	SUBROUTINE SH_GFOS  ( bultin, lenb, ibpnt, ireptyp, report, 
     +                           lenr, iret )
C************************************************************************
C* SH_GRPT								*
C*									*
...
C*
        CHARACTER*3     cont
        CHARACTER*1     cnum
	CHARACTER*(DCMXBF) bultin, report
        CHARACTER*(DCMXBF) tmpstr
C-----------------------------------------------------------------------
        iret = 0 
	lenr = 0
        ia = 0
